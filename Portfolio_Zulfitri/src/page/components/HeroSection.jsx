    ...
    <section className="animate-slide-fade border-b border-[#2a2a2a] px-5 py-6 md:px-12 md:py-11">
      <div className="flex flex-col-reverse gap-6 md:flex-row md:items-center md:justify-between md:gap-10">
        ...
        <div className="relative mx-auto h-56 w-56 shrink-0 animate-profile-float md:mx-0 md:h-104 md:w-104">
          <div className="pointer-events-none absolute inset-0 -z-10 rounded-full bg-[#f97316]/20 blur-2xl animate-profile-glow" />
          <div className="h-full w-full overflow-hidden rounded-full border-2 border-[#f97316] shadow-[0_0_0_8px_rgba(249,115,22,0.12)]">
          <img
            alt="Zulfitri profile"
      ...
      <div className="mt-6">
        ...
        <div className="mt-3 flex flex-wrap gap-2.5">
          {toolStack.map((tool, index) => (
            <span
              key={tool}
              className="animate-badge-pulse rounded-full border border-[#f97316]/40 bg-[#f97316]/10 px-3 py-1.5 text-xs font-bold text-[#f97316]"
